...
// Fetch User Profile Image & Notifications if logged in
$profile_image = null;
...
if (isset($_SESSION['userid'])) {
    ...
    if ($role === 'customer') {
        ...
        if ($u_res && $u_row = mysqli_fetch_assoc($u_res)) {
            ...
            $cust_notif_res = mysqli_query($conn, "SELECT * FROM notifications WHERE user_id = $uid AND user_type = 'customer' ORDER BY created_at DESC LIMIT 5");
        }
    }
}
?>
